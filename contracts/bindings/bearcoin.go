...
//
// Solidity: function MILLION() view returns(uint32)
func (_BearCoin *BearCoinCaller) MILLION(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _BearCoin.contract.Call(opts, &out, "MILLION")
...
//
// Solidity: function MILLION() view returns(uint32)
func (_BearCoin *BearCoinSession) MILLION() (uint32, error) {
	return _BearCoin.Contract.MILLION(&_BearCoin.CallOpts)
}

// MILLION is a free data retrieval call binding the contract method 0x32bc934c.
//
// Solidity: function MILLION() view returns(uint32)
func (_BearCoin *BearCoinCallerSession) MILLION() (uint32, error) {
	return _BearCoin.Contract.MILLION(&_BearCoin.CallOpts)
}
